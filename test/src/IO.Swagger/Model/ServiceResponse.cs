...
namespace IO.Swagger.Model
{
    ...
    public partial class ServiceResponse :  IEquatable<ServiceResponse>, IValidatableObject
    {
        ...
        public ServiceResponse(string Message = default(string), string WorkerName = default(string), Dictionary<string, string> Data = default(Dictionary<string, string>), ServiceResponseWorkerCallState WorkerCallState = default(ServiceResponseWorkerCallState))
        {
