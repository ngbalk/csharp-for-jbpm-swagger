...
*DefaultApi* | [**ServerContainersContainerIdProcessesInstancesPInstanceIdSignalSignalNamePost**](docs/DefaultApi.md#servercontainerscontaineridprocessesinstancespinstanceidsignalsignalnamepost) | **POST** /server/containers/{containerId}/processes/instances/{pInstanceId}/signal/{signalName} | 
...
*DefaultApi* | [**ServerQueriesContainersContainerIdProcessesDefinitionsGet**](docs/DefaultApi.md#serverqueriescontainerscontaineridprocessesdefinitionsget) | **GET** /server/queries/containers/{containerId}/processes/definitions/ | 
...
## Documentation for Models
 ...
 - [Model.IncidentData](docs/IncidentData.md)
 ...
 - [Model.PaymentData](docs/PaymentData.md)
 ...
 - [Model.ServiceResponseSignalInstanceInfo](docs/ServiceResponseSignalInstanceInfo.md)
 - [Model.ServiceResponseWorkerCallState](docs/ServiceResponseWorkerCallState.md)
 - [Model.WorkerError](docs/WorkerError.md)
